...
parser.add_argument('--datatype', default='2015',
                    help='datapath')
parser.add_argument('--datapath', default=r"E:/TU-delft/CS4240 - Deep Learning/PSMNet/dataset/sceneflow flyingthings3d/" ,
                    help='datapath')
parser.add_argument('--epochs', type=int, default=1,
                    help='number of epochs to train')
parser.add_argument('--loadmodel', default=r'E:\TU-delft\CS4240 - Deep Learning\PSMNet\trained\pretrained_model_KITTI2015.tar',
                    help='load model')
parser.add_argument('--savemodel', default='./training/',
                    help='save model')
