...
parser.add_argument('--loadmodel', default='./pretrained_model_KITTI2012.tar',
                    help='load model')
...
TrainImgLoader = torch.utils.data.DataLoader(
    ...
    batch_size=4, shuffle=True, num_workers=2, drop_last=False) #12 worker 8

TestImgLoader = torch.utils.data.DataLoader(
    DA.myImageFloder(test_left_img, test_right_img, test_left_disp, False),
    batch_size=4, shuffle=False, num_workers=2, drop_last=False) #8 worker 4
...
def test(imgL, imgR, disp_true):
    ...
    true_disp = disp_true
    true_disp = torch.squeeze(true_disp)
